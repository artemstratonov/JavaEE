...
<header>
    ...
    <table>
        ...
        <form action="${pageContext.request.contextPath}/AddingContract" method="post"><tr><th><input type="text" name="id"></th><th><input type="text" name="apartmentid"></th><th><input type="text" name="realtorid"></th><th><button class="enter-btn">Input</button></th></tr></form>
        <form action="${pageContext.request.contextPath}/EditContract" method="post"><tr><th><input type="text" name="id"></th><th><input type="text" name="apartmentid"></th><th><input type="text" name="realtorid"></th><th><button class="enter-btn">Edit</button></th></tr></form>
        <form action="${pageContext.request.contextPath}/DeletingContract" method="post"><tr><th><input type="text" name="id"></th><th><button class="enter-btn">Delete</button></th></tr></form>
    </table>
</header>
</body>
</html>
